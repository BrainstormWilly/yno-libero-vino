...
export default function MailchimpSMSProvider({ existingConfig }: SMSProviderComponentProps) {
      ...
      <Card>
        <BlockStack gap="400">
          <Text variant="headingMd" as="h3">
            SMS Provider: Mailchimp SMS
          </Text>

          <Banner tone="info">
            <BlockStack gap="200">
              <Text as="p" variant="bodyMd" fontWeight="semibold">
                Finding Your Mailchimp SMS Credentials
              </Text>
              <Text as="p" variant="bodySm">
                1. Log in to your Mailchimp account
              </Text>
              <Text as="p" variant="bodySm">
                2. Go to <strong>Account → Settings → SMS</strong>
              </Text>
              <Text as="p" variant="bodySm">
                3. Generate an API key for SMS messaging
              </Text>
              <Text as="p" variant="bodySm">
          ...
          <TextField
            label="Mailchimp SMS API Key"
            type="password"
            value={smsApiKey}
            onChange={setSmsApiKey}
            autoComplete="off"
            requiredIndicator
            helpText="Your Mailchimp SMS API key"
          />
